 ...
 * resource:TblStudentFacadeREST
 * [entities.tblstudent]<br>
 *  USAGE:
 * <pre>
 *        LinkedJavaRestWS client = new LinkedJavaRestWS();
 ...
 */
public class LinkedJavaRestWS {
  private WebResource webResource;
  private Client client;
  private static final String BASE_URI = "http://localhost:8080/JavaRestWebTrial/webresources";

  public LinkedJavaRestWS() {
    com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
    client = Client.create(config);
    webResource = client.resource(BASE_URI).path("entities.tblstudent");
  }
